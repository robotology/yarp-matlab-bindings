classdef ImageInt < yarp.Image
  methods
    ...
    %retval is of type int. 
      [varargout{1:max(1,nargout)}] = yarpMATLAB_wrap(1968,'ImageInt_getPixelSize',self,varargin{:});
    end
    function varargout = getPixelCode(self,varargin)
    %Usage: retval = getPixelCode ()
    %
    %retval is of type int. 
      [varargout{1:max(1,nargout)}] = yarpMATLAB_wrap(1969,'ImageInt_getPixelCode',self,varargin{:});
    end
    ...
    %x is of type int. y is of type int. x is of type int. y is of type int. retval is of type yarp::sig::PixelInt &. 
      [varargout{1:max(1,nargout)}] = yarpMATLAB_wrap(1970,'ImageInt_pixel',self,varargin{:});
    end
    function varargout = access(self,varargin)
    %Usage: retval = access (x, y)
    %
    %x is of type int. y is of type int. x is of type int. y is of type int. retval is of type yarp::sig::PixelInt &. 
      [varargout{1:max(1,nargout)}] = yarpMATLAB_wrap(1971,'ImageInt_access',self,varargin{:});
    end
    ...
    %x is of type int. y is of type int. x is of type int. y is of type int. retval is of type yarp::sig::PixelInt const &. 
      [varargout{1:max(1,nargout)}] = yarpMATLAB_wrap(1972,'ImageInt_safePixel',self,varargin{:});
    end
    ...
    %x is of type int. y is of type int. x is of type int. y is of type int. retval is of type int. 
      [varargout{1:max(1,nargout)}] = yarpMATLAB_wrap(1973,'ImageInt_getPixel',self,varargin{:});
    end
    function varargout = setPixel(self,varargin)
    %Usage: setPixel (x, y, v)
    %
    %x is of type int. y is of type int. v is of type int. 
      [varargout{1:nargout}] = yarpMATLAB_wrap(1974,'ImageInt_setPixel',self,varargin{:});
    end
    function self = ImageInt(varargin)
      self@yarp.Image('_swigCreate');
      if nargin~=1 || ~ischar(varargin{1}) || ~strcmp(varargin{1},'_swigCreate')
        % How to get working on C side? Commented out, replaed by hack below
        %self.swigCPtr = yarpMATLAB_wrap(1975,'new_ImageInt',varargin{:});
        %self.swigOwn = true;
        tmp = yarpMATLAB_wrap(1975,'new_ImageInt',varargin{:}); % FIXME
    ...
    function delete(self)
      if self.swigOwn
        yarpMATLAB_wrap(1976,'delete_ImageInt',self);
        self.swigOwn=false;
      end
    end
