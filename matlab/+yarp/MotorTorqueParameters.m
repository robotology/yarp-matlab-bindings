classdef MotorTorqueParameters < SwigRef
  ...
  methods
    ...
    function varargout = bemf(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1485, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1486, self, varargin{1});
      end
    end
    function varargout = bemf_scale(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1487, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1488, self, varargin{1});
      end
    end
    function varargout = ktau(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1489, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1490, self, varargin{1});
      end
    end
    function varargout = ktau_scale(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1491, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1492, self, varargin{1});
      end
    end
