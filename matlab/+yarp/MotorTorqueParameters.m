classdef MotorTorqueParameters < SwigRef
  ...
  methods
    ...
    function varargout = bemf(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1508, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1509, self, varargin{1});
      end
    end
    function varargout = bemf_scale(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1510, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1511, self, varargin{1});
      end
    end
    function varargout = ktau(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1512, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1513, self, varargin{1});
      end
    end
    function varargout = ktau_scale(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1514, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1515, self, varargin{1});
      end
    end
