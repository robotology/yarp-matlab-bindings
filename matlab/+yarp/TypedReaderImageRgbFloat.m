classdef TypedReaderImageRgbFloat < SwigRef
  ...
  methods
    ...
    %Usage: setStrict ()
    %
      [varargout{1:nargout}] = yarpMATLAB_wrap(2186, self, varargin{:});
    end
    function varargout = read(self,varargin)
    %Usage: retval = read ()
    %
    %retval is of type ImageRgbFloat. 
      [varargout{1:max(1,nargout)}] = yarpMATLAB_wrap(2187, self, varargin{:});
    end
    function varargout = interrupt(self,varargin)
    %Usage: interrupt ()
    %
      [varargout{1:nargout}] = yarpMATLAB_wrap(2188, self, varargin{:});
    end
    function varargout = lastRead(self,varargin)
    %Usage: retval = lastRead ()
    %
    %retval is of type ImageRgbFloat. 
      [varargout{1:max(1,nargout)}] = yarpMATLAB_wrap(2189, self, varargin{:});
    end
    function varargout = isClosed(self,varargin)
    %Usage: retval = isClosed ()
    %
    %retval is of type bool. 
      [varargout{1:max(1,nargout)}] = yarpMATLAB_wrap(2190, self, varargin{:});
    end
    ...
    %callback is of type TypedReaderCallbackImageRgbFloat. 
      [varargout{1:nargout}] = yarpMATLAB_wrap(2191, self, varargin{:});
    end
    function varargout = disableCallback(self,varargin)
    %Usage: disableCallback ()
    %
      [varargout{1:nargout}] = yarpMATLAB_wrap(2192, self, varargin{:});
    end
    function varargout = getPendingReads(self,varargin)
    %Usage: retval = getPendingReads ()
    %
    %retval is of type int. 
      [varargout{1:max(1,nargout)}] = yarpMATLAB_wrap(2193, self, varargin{:});
    end
    function delete(self)
      if self.swigInd
        yarpMATLAB_wrap(2194, self);
