classdef ICurrentControlRaw < yarpSwigRef
  ...
  methods
    ...
    %
    %number is of type int *. number is of type int *. retval is of type ReturnValue. 
    ...
    %
    %m is of type int. curr is of type double *. m is of type int. curr is of type double *. retval is of type ReturnValue. 
    ...
    %
    %currs is of type double *. currs is of type double *. retval is of type ReturnValue. 
    ...
    %
    %m is of type int. min is of type double *. max is of type double *. m is of type int. min is of type double *. max is of type double *. retval is of type ReturnValue. 
    ...
    %
    %n_motor is of type int const. motors is of type int const *. currs is of type double const *. n_motor is of type int const. motors is of type int const *. currs is of type double const *. retval is of type ReturnValue. 
