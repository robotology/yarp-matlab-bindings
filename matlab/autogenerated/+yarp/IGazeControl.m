classdef IGazeControl < SwigRef
  ...
  methods
    ...
    %
    %fp is of type yarp::sig::Vector &. fp is of type yarp::sig::Vector &. retval is of type bool. 
      [varargout{1:nargout}] = yarpMEX(1484, self, varargin{:});
    end
    function varargout = getAngles(self,varargin)
    %Usage: retval = getAngles (ang)
    %
    %ang is of type yarp::sig::Vector &. ang is of type yarp::sig::Vector &. retval is of type bool. 
    ...
    %
    %fp is of type yarp::sig::Vector const &. fp is of type yarp::sig::Vector const &. retval is of type bool. 
    ...
    %
    %ang is of type yarp::sig::Vector const &. ang is of type yarp::sig::Vector const &. retval is of type bool. 
    ...
    %
    %camSel is of type int const. px is of type yarp::sig::Vector const &. camSel is of type int const. px is of type yarp::sig::Vector const &. retval is of type bool. 
    ...
    %
    %camSel is of type int const. px is of type yarp::sig::Vector const &. ver is of type double const. camSel is of type int const. px is of type yarp::sig::Vector const &. ver is of type double const. retval is of type bool. 
    ...
    %
    %pxl is of type yarp::sig::Vector const &. pxr is of type yarp::sig::Vector const &. pxl is of type yarp::sig::Vector const &. pxr is of type yarp::sig::Vector const &. retval is of type bool. 
    ...
    %
    %x is of type yarp::sig::Vector &. od is of type yarp::sig::Vector &. x is of type yarp::sig::Vector &. od is of type yarp::sig::Vector &. retval is of type bool. 
    ...
    %
    %camSel is of type int const. x is of type yarp::sig::Vector const &. px is of type yarp::sig::Vector &. camSel is of type int const. x is of type yarp::sig::Vector const &. px is of type yarp::sig::Vector &. retval is of type bool. 
    ...
    %
    %camSel is of type int const. px is of type yarp::sig::Vector const &. z is of type double const. x is of type yarp::sig::Vector &. camSel is of type int const. px is of type yarp::sig::Vector const &. z is of type double const. x is of type yarp::sig::Vector &. retval is of type bool. 
    ...
    %
    %camSel is of type int const. px is of type yarp::sig::Vector const &. plane is of type yarp::sig::Vector const &. x is of type yarp::sig::Vector &. camSel is of type int const. px is of type yarp::sig::Vector const &. plane is of type yarp::sig::Vector const &. x is of type yarp::sig::Vector &. retval is of type bool. 
    ...
    %
    %mode is of type int const. ang is of type yarp::sig::Vector const &. x is of type yarp::sig::Vector &. mode is of type int const. ang is of type yarp::sig::Vector const &. x is of type yarp::sig::Vector &. retval is of type bool. 
    ...
    %
    %x is of type yarp::sig::Vector const &. ang is of type yarp::sig::Vector &. x is of type yarp::sig::Vector const &. ang is of type yarp::sig::Vector &. retval is of type bool. 
    ...
    %
    %pxl is of type yarp::sig::Vector const &. pxr is of type yarp::sig::Vector const &. x is of type yarp::sig::Vector &. pxl is of type yarp::sig::Vector const &. pxr is of type yarp::sig::Vector const &. x is of type yarp::sig::Vector &. retval is of type bool. 
    ...
    %
    %qdes is of type yarp::sig::Vector &. qdes is of type yarp::sig::Vector &. retval is of type bool. 
    ...
    %
    %qdot is of type yarp::sig::Vector &. qdot is of type yarp::sig::Vector &. retval is of type bool. 
