classdef ITorqueControlRaw < yarpSwigRef
  ...
  methods
    ...
    %
    %j is of type int. t is of type double *. j is of type int. t is of type double *. retval is of type ReturnValue. 
      [varargout{1:nargout}] = yarpMEX(1561, self, varargin{:});
    end
    function varargout = getTorquesRaw(self,varargin)
    %Usage: retval = getTorquesRaw (t)
    %
    %t is of type double *. t is of type double *. retval is of type ReturnValue. 
    ...
    %
    %j is of type int. min is of type double *. max is of type double *. j is of type int. min is of type double *. max is of type double *. retval is of type ReturnValue. 
    ...
    %
    %min is of type double *. max is of type double *. min is of type double *. max is of type double *. retval is of type ReturnValue. 
    ...
    %
    %n_joint is of type int const. joints is of type int const *. t is of type double const *. n_joint is of type int const. joints is of type int const *. t is of type double const *. retval is of type ReturnValue. 
    ...
    %
    %j is of type int. params is of type MotorTorqueParameters. j is of type int. params is of type MotorTorqueParameters. retval is of type ReturnValue. 
