classdef Pid < SwigRef
  ...
  methods
    ...
    function varargout = kp(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1429, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1430, self, varargin{1});
      end
    end
    ...
    function varargout = max_int(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1435, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1436, self, varargin{1});
      end
    end
    function varargout = scale(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1437, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1438, self, varargin{1});
      end
    end
    function varargout = max_output(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1439, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1440, self, varargin{1});
      end
    end
    function varargout = offset(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1441, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1442, self, varargin{1});
      end
    end
    function varargout = stiction_up_val(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1443, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1444, self, varargin{1});
      end
    end
    function varargout = stiction_down_val(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1445, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1446, self, varargin{1});
      end
    end
