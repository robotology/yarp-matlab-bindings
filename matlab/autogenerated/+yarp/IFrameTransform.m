classdef IFrameTransform < yarpSwigRef
  ...
  methods
    ...
    %
    %target_frame_id is of type std::string const &. source_frame_id is of type std::string const &. transform is of type Matrix. target_frame_id is of type std::string const &. source_frame_id is of type std::string const &. transform is of type Matrix. retval is of type ReturnValue. 
    ...
    %
    %target_frame_id is of type std::string const &. source_frame_id is of type std::string const &. target_frame_id is of type std::string const &. source_frame_id is of type std::string const &. retval is of type ReturnValue. 
    ...
    %
    %target_frame_id is of type std::string const &. source_frame_id is of type std::string const &. input_point is of type Vector. transformed_point is of type Vector. target_frame_id is of type std::string const &. source_frame_id is of type std::string const &. input_point is of type Vector. transformed_point is of type Vector. retval is of type ReturnValue. 
    ...
    %
    %target_frame_id is of type std::string const &. source_frame_id is of type std::string const &. input_pose is of type Vector. transformed_pose is of type Vector. target_frame_id is of type std::string const &. source_frame_id is of type std::string const &. input_pose is of type Vector. transformed_pose is of type Vector. retval is of type ReturnValue. 
    ...
    %
    %target_frame_id is of type std::string const &. source_frame_id is of type std::string const &. input_quaternion is of type yarp::math::Quaternion const &. transformed_quaternion is of type yarp::math::Quaternion &. target_frame_id is of type std::string const &. source_frame_id is of type std::string const &. input_quaternion is of type yarp::math::Quaternion const &. transformed_quaternion is of type yarp::math::Quaternion &. retval is of type ReturnValue. 
    ...
    %
    %target_frame_id is of type std::string const &. source_frame_id is of type std::string const &. timeout is of type double const &. target_frame_id is of type std::string const &. source_frame_id is of type std::string const &. timeout is of type double const &. retval is of type ReturnValue. 
