classdef PolyDriver < yarp.DeviceDriver
  ...
  methods
    ...
    function varargout = viewIJointCoupling(self,varargin)
    %Usage: retval = viewIJointCoupling ()
    %
    %retval is of type IJointCoupling. 
    ...
    function varargout = viewIRGBDSensor(self,varargin)
    %Usage: retval = viewIRGBDSensor ()
    %
    %retval is of type IRGBDSensor. 
      [varargout{1:nargout}] = yarpMEX(972, self, varargin{:});
    end
    function varargout = viewIBattery(self,varargin)
    %Usage: retval = viewIBattery ()
    %
    %retval is of type IBattery. 
      [varargout{1:nargout}] = yarpMEX(973, self, varargin{:});
    end
    function varargout = viewISimulatedWorld(self,varargin)
    %Usage: retval = viewISimulatedWorld ()
    %
    %retval is of type ISimulatedWorld. 
    ...
    %
    %retval is of type IFrameTransform. 
      [varargout{1:nargout}] = yarpMEX(975, self, varargin{:});
    end
    function varargout = viewINavigation2D(self,varargin)
    %Usage: retval = viewINavigation2D ()
    %
    %retval is of type INavigation2D. 
      [varargout{1:nargout}] = yarpMEX(976, self, varargin{:});
    end
    function varargout = viewILocalization2D(self,varargin)
    %Usage: retval = viewILocalization2D ()
    %
    %retval is of type ILocalization2D. 
      [varargout{1:nargout}] = yarpMEX(977, self, varargin{:});
    end
    function varargout = viewIMap2D(self,varargin)
    %Usage: retval = viewIMap2D ()
    %
    %retval is of type IMap2D. 
