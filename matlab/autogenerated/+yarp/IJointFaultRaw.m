classdef IJointFaultRaw < yarpSwigRef
  ...
  methods
    ...
    %
    %j is of type int. mode is of type int &. message is of type std::string &. j is of type int. mode is of type int &. message is of type std::string &. retval is of type ReturnValue. 
