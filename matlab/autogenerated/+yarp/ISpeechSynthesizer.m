classdef ISpeechSynthesizer < yarpSwigRef
  ...
  methods
    ...
    %
    %pitch is of type double const. pitch is of type double const. retval is of type yarp::dev::ReturnValue. 
    ...
    %
    %text is of type std::string const &. sound is of type Sound. text is of type std::string const &. sound is of type Sound. retval is of type yarp::dev::ReturnValue. 
