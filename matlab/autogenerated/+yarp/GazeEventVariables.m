classdef GazeEventVariables < yarpSwigRef
  ...
  methods
    ...
    function varargout = type(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1422, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1423, self, varargin{1});
      end
    end
    function varargout = time(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1424, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1425, self, varargin{1});
      end
    end
    function varargout = motionOngoingCheckPoint(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1426, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1427, self, varargin{1});
      end
    end
