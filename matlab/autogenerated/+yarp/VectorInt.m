classdef VectorInt < yarp.VectorBase
  ...
  methods
    ...
    %retval is of type size_t. 
      [varargout{1:nargout}] = yarpMEX(3124, self, varargin{:});
    end
    function varargout = getBottleTag(self,varargin)
    %Usage: retval = getBottleTag ()
    %
    %retval is of type int. 
      [varargout{1:nargout}] = yarpMEX(3125, self, varargin{:});
    end
    function varargout = getListSize(self,varargin)
    %Usage: retval = getListSize ()
    %
    %retval is of type size_t. 
      [varargout{1:nargout}] = yarpMEX(3126, self, varargin{:});
    end
    function varargout = getMemoryBlock(self,varargin)
    %Usage: retval = getMemoryBlock ()
    %
    %retval is of type char *. 
      [varargout{1:nargout}] = yarpMEX(3127, self, varargin{:});
    end
    function varargout = data(self,varargin)
    %Usage: retval = data ()
    %
    %retval is of type int const *. 
      [varargout{1:nargout}] = yarpMEX(3128, self, varargin{:});
    end
    function varargout = erase(self,varargin)
    %Usage: erase (first, last)
    %
    %first is of type yarp::sig::VectorOf< int >::iterator. last is of type yarp::sig::VectorOf< int >::iterator. 
      [varargout{1:nargout}] = yarpMEX(3129, self, varargin{:});
    end
    function varargout = resize(self,varargin)
    %Usage: resize (size, def)
    %
    %size is of type size_t. def is of type int const &. 
      [varargout{1:nargout}] = yarpMEX(3130, self, varargin{:});
    end
    function varargout = reserve(self,varargin)
    %Usage: reserve (size)
    %
    %size is of type size_t. 
      [varargout{1:nargout}] = yarpMEX(3131, self, varargin{:});
    end
    function varargout = push_back(self,varargin)
    %Usage: push_back (elem)
    %
    %elem is of type int &&. 
      [varargout{1:nargout}] = yarpMEX(3132, self, varargin{:});
    end
    function varargout = pop_back(self,varargin)
    %Usage: pop_back ()
    %
      [varargout{1:nargout}] = yarpMEX(3133, self, varargin{:});
    end
    function varargout = brace(self,varargin)
    %Usage: retval = brace (i)
    %
    %i is of type size_t. i is of type size_t. retval is of type int const &. 
      [varargout{1:nargout}] = yarpMEX(3134, self, varargin{:});
    end
    function varargout = access(self,varargin)
    %Usage: retval = access (i)
    %
    %i is of type size_t. i is of type size_t. retval is of type int const &. 
      [varargout{1:nargout}] = yarpMEX(3135, self, varargin{:});
    end
    function varargout = size(self,varargin)
    %Usage: retval = size ()
    %
    %retval is of type size_t. 
      [varargout{1:nargout}] = yarpMEX(3136, self, varargin{:});
    end
    function varargout = length(self,varargin)
    %Usage: retval = length ()
    %
    %retval is of type size_t. 
      [varargout{1:nargout}] = yarpMEX(3137, self, varargin{:});
    end
    function varargout = capacity(self,varargin)
    %Usage: retval = capacity ()
    %
    %retval is of type size_t. 
      [varargout{1:nargout}] = yarpMEX(3138, self, varargin{:});
    end
    function varargout = zero(self,varargin)
    %Usage: zero ()
    %
      [varargout{1:nargout}] = yarpMEX(3139, self, varargin{:});
    end
    function varargout = toString(self,varargin)
    %Usage: retval = toString (precision = -1)
    %
    %precision is of type int. precision is of type int. retval is of type std::string. 
      [varargout{1:nargout}] = yarpMEX(3140, self, varargin{:});
    end
    function varargout = toString_c(self,varargin)
    %Usage: retval = toString_c ()
    %
    %retval is of type std::string. 
      [varargout{1:nargout}] = yarpMEX(3141, self, varargin{:});
    end
    ...
    %first is of type unsigned int. last is of type unsigned int. first is of type unsigned int. last is of type unsigned int. retval is of type VectorInt. 
      [varargout{1:nargout}] = yarpMEX(3142, self, varargin{:});
    end
    ...
    %position is of type int. v is of type VectorInt. position is of type int. v is of type VectorInt. retval is of type bool. 
      [varargout{1:nargout}] = yarpMEX(3143, self, varargin{:});
    end
    function varargout = isEqual(self,varargin)
    %Usage: retval = isEqual (r)
    %
    %r is of type VectorInt. r is of type VectorInt. retval is of type bool. 
      [varargout{1:nargout}] = yarpMEX(3144, self, varargin{:});
    end
    function varargout = begin(self,varargin)
    %Usage: retval = begin ()
    %
    %retval is of type yarp::sig::VectorOf< int >::const_iterator. 
      [varargout{1:nargout}] = yarpMEX(3145, self, varargin{:});
    end
    function varargout = end(self,varargin)
    %Usage: retval = end ()
    %
    %retval is of type yarp::sig::VectorOf< int >::const_iterator. 
      [varargout{1:nargout}] = yarpMEX(3146, self, varargin{:});
    end
    function varargout = cbegin(self,varargin)
    %Usage: retval = cbegin ()
    %
    %retval is of type yarp::sig::VectorOf< int >::const_iterator. 
      [varargout{1:nargout}] = yarpMEX(3147, self, varargin{:});
    end
    function varargout = cend(self,varargin)
    %Usage: retval = cend ()
    %
    %retval is of type yarp::sig::VectorOf< int >::const_iterator. 
      [varargout{1:nargout}] = yarpMEX(3148, self, varargin{:});
    end
    function varargout = clear(self,varargin)
    %Usage: clear ()
    %
      [varargout{1:nargout}] = yarpMEX(3149, self, varargin{:});
    end
    ...
    %j is of type int. j is of type int. retval is of type int. 
      [varargout{1:nargout}] = yarpMEX(3151, self, varargin{:});
    end
    function varargout = set(self,varargin)
    %Usage: set (j, v)
    %
    %j is of type int. v is of type int. 
      [varargout{1:nargout}] = yarpMEX(3152, self, varargin{:});
    end
  end
  methods(Static)
  end
