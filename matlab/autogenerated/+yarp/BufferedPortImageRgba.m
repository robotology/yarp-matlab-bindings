classdef BufferedPortImageRgba < yarp.Contactable & yarp.TypedReaderImageRgba & yarp.ImageRgbaCallback
  ...
  methods
    ...
    function self = BufferedPortImageRgba(varargin)
      ...
      self@yarp.TypedReaderImageRgba(yarpSwigRef.Null);
      self@yarp.ImageRgbaCallback(yarpSwigRef.Null);
    ...
    %retval is of type int. 
      [varargout{1:nargout}] = yarpMEX(2627, self, varargin{:});
    end
    ...
    %retval is of type ImageRgba. 
      [varargout{1:nargout}] = yarpMEX(2630, self, varargin{:});
    end
    function varargout = unprepare(self,varargin)
    %Usage: retval = unprepare ()
    %
    %retval is of type bool. 
      [varargout{1:nargout}] = yarpMEX(2631, self, varargin{:});
    end
