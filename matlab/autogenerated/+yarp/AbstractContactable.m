classdef AbstractContactable < yarp.UnbufferedContactable
  ...
  methods
    ...
    %retval is of type Port. 
      [varargout{1:nargout}] = yarpMEX(363, self, varargin{:});
    end
    ...
    %contact is of type Contact. contact is of type Contact. retval is of type bool. 
      [varargout{1:nargout}] = yarpMEX(364, self, varargin{:});
    end
    function varargout = addOutput(self,varargin)
    %Usage: retval = addOutput (contact)
    %
    %contact is of type Contact. contact is of type Contact. retval is of type bool. 
      [varargout{1:nargout}] = yarpMEX(365, self, varargin{:});
    end
    function varargout = close(self,varargin)
    %Usage: close ()
    %
      [varargout{1:nargout}] = yarpMEX(366, self, varargin{:});
    end
    function varargout = interrupt(self,varargin)
    %Usage: interrupt ()
    %
      [varargout{1:nargout}] = yarpMEX(367, self, varargin{:});
    end
    ...
    %retval is of type std::string. 
      [varargout{1:nargout}] = yarpMEX(370, self, varargin{:});
    end
