classdef MotorTorqueParameters < SwigRef
  ...
  methods
    ...
    function varargout = bemf(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1803, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1804, self, varargin{1});
      end
    end
    function varargout = bemf_scale(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1805, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1806, self, varargin{1});
      end
    end
    function varargout = ktau(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1807, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1808, self, varargin{1});
      end
    end
    function varargout = ktau_scale(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1809, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1810, self, varargin{1});
      end
    end
