classdef MotorTorqueParameters < yarpSwigRef
  ...
  methods
    ...
    function varargout = bemf(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1739, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1740, self, varargin{1});
      end
    end
    function varargout = bemf_scale(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1741, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1742, self, varargin{1});
      end
    end
    function varargout = ktau(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1743, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1744, self, varargin{1});
      end
    end
    function varargout = ktau_scale(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1745, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1746, self, varargin{1});
      end
    end
