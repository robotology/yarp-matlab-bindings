classdef MotorTorqueParameters < SwigRef
  ...
  methods
    ...
    function varargout = bemf(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1526, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1527, self, varargin{1});
      end
    end
    function varargout = bemf_scale(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1528, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1529, self, varargin{1});
      end
    end
    function varargout = ktau(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1530, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1531, self, varargin{1});
      end
    end
    function varargout = ktau_scale(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1532, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1533, self, varargin{1});
      end
    end
