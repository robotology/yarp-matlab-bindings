classdef MotorTorqueParameters < SwigRef
  ...
  methods
    ...
    function varargout = bemf(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1730, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1731, self, varargin{1});
      end
    end
    function varargout = bemf_scale(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1732, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1733, self, varargin{1});
      end
    end
    function varargout = ktau(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1734, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1735, self, varargin{1});
      end
    end
    function varargout = ktau_scale(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1736, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1737, self, varargin{1});
      end
    end
