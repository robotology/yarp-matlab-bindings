classdef MotorTorqueParameters < yarpSwigRef
  ...
  methods
    ...
    function varargout = ktau_scale(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1533, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1534, self, varargin{1});
      end
    end
    function varargout = viscousPos(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1535, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1536, self, varargin{1});
      end
    end
    function varargout = viscousNeg(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1537, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1538, self, varargin{1});
      end
    end
    function varargout = coulombPos(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1539, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1540, self, varargin{1});
      end
    end
    function varargout = coulombNeg(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1541, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1542, self, varargin{1});
      end
    end
    function varargout = velocityThres(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = yarpMEX(1543, self);
      else
        nargoutchk(0, 0)
        yarpMEX(1544, self, varargin{1});
      end
    end
