classdef IPidControl < yarpSwigRef
  ...
  methods
    ...
    function varargout = getAvailablePids(self,varargin)
    %Usage: retval = getAvailablePids (j, avail)
    %
    ...
    function varargout = getPidExtraInfo(self,varargin)
    %Usage: retval = getPidExtraInfo (pidtype, j, info)
    %
    ...
    function varargout = getPidExtraInfos(self,varargin)
    %Usage: retval = getPidExtraInfos (pidtype, info)
    %
    ...
    function varargout = setPidFeedforward(self,varargin)
    %Usage: retval = setPidFeedforward (pidtype, j, v)
    %
    ...
    function varargout = getPidOffset(self,varargin)
    %Usage: retval = getPidOffset (pidtype, j, v)
    %
    %pidtype is of type PidControlTypeEnum const &. j is of type int. v is of type double &. pidtype is of type PidControlTypeEnum const &. j is of type int. v is of type double &. retval is of type ReturnValue. 
      [varargout{1:nargout}] = yarpMEX(1715, self, varargin{:});
    end
    function varargout = getPidFeedforward(self,varargin)
    %Usage: retval = getPidFeedforward (pidtype, j, v)
    %
    %pidtype is of type PidControlTypeEnum const &. j is of type int. v is of type double &. pidtype is of type PidControlTypeEnum const &. j is of type int. v is of type double &. retval is of type ReturnValue. 
    ...
    %
    %pidtype is of type int. j is of type int. flag is of type bool &. pidtype is of type int. j is of type int. flag is of type bool &. retval is of type bool. 
