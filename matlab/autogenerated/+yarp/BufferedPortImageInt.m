classdef BufferedPortImageInt < yarp.Contactable & yarp.TypedReaderImageInt & yarp.ImageIntCallback
  ...
  methods
    ...
    function self = BufferedPortImageInt(varargin)
      ...
      self@yarp.ImageIntCallback(yarpSwigRef.Null);
      if nargin==1 && strcmp(class(varargin{1}),'yarpSwigRef')
        if ~isnull(varargin{1})
          self.swigPtr = varargin{1}.swigPtr;
        end
      else
        tmp = yarpMEX(2836, varargin{:});
