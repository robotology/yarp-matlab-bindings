classdef NetworkBase < SwigRef
  ...
  methods(Static)
    ...
    %
    %src is of type yarp::os::ConstString const &. dest is of type yarp::os::ConstString const &. style is of type QosStyle. src is of type yarp::os::ConstString const &. dest is of type yarp::os::ConstString const &. style is of type QosStyle. retval is of type bool. 
