classdef Value < yarp.Portable & yarp.Searchable
  ...
  methods
    ...
    function varargout = isVocab64(self,varargin)
    %Usage: retval = isVocab64 ()
    %
    %retval is of type bool. 
    ...
    function varargout = asVocab64(self,varargin)
    %Usage: retval = asVocab64 ()
    %
    %retval is of type yarp::conf::vocab64_t. 
