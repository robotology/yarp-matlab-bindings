classdef BufferedPortImageFloat < yarp.Contactable & yarp.TypedReaderImageFloat & yarp.ImageFloatCallback
  ...
  methods
    ...
    function self = BufferedPortImageFloat(varargin)
      ...
      self@yarp.TypedReaderImageFloat(yarpSwigRef.Null);
      self@yarp.ImageFloatCallback(yarpSwigRef.Null);
      if nargin==1 && strcmp(class(varargin{1}),'yarpSwigRef')
        if ~isnull(varargin{1})
          self.swigPtr = varargin{1}.swigPtr;
        end
      else
        tmp = yarpMEX(2909, varargin{:});
    ...
    %envelope is of type PortWriter. envelope is of type PortWriter. retval is of type bool. 
      [varargout{1:nargout}] = yarpMEX(2933, self, varargin{:});
    end
