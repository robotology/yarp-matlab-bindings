classdef ICartesianControl < SwigRef
  ...
  methods
    ...
    %
    %axis is of type int const. x is of type yarp::sig::Vector &. o is of type yarp::sig::Vector &. axis is of type int const. x is of type yarp::sig::Vector &. o is of type yarp::sig::Vector &. retval is of type bool. 
      [varargout{1:nargout}] = yarpMEX(1422, self, varargin{:});
    end
    function varargout = goToPose(self,varargin)
    %Usage: retval = goToPose (xd, od)
    %
    %xd is of type yarp::sig::Vector const &. od is of type yarp::sig::Vector const &. xd is of type yarp::sig::Vector const &. od is of type yarp::sig::Vector const &. retval is of type bool. 
      [varargout{1:nargout}] = yarpMEX(1423, self, varargin{:});
    end
    function varargout = goToPosition(self,varargin)
    %Usage: retval = goToPosition (xd)
    %
    %xd is of type yarp::sig::Vector const &. xd is of type yarp::sig::Vector const &. retval is of type bool. 
    ...
    %
    %xdhat is of type yarp::sig::Vector &. odhat is of type yarp::sig::Vector &. qdhat is of type yarp::sig::Vector &. xdhat is of type yarp::sig::Vector &. odhat is of type yarp::sig::Vector &. qdhat is of type yarp::sig::Vector &. retval is of type bool. 
    ...
    %
    %q0 is of type yarp::sig::Vector const &. xd is of type yarp::sig::Vector const &. od is of type yarp::sig::Vector const &. xdhat is of type yarp::sig::Vector &. odhat is of type yarp::sig::Vector &. qdhat is of type yarp::sig::Vector &. q0 is of type yarp::sig::Vector const &. xd is of type yarp::sig::Vector const &. od is of type yarp::sig::Vector const &. xdhat is of type yarp::sig::Vector &. odhat is of type yarp::sig::Vector &. qdhat is of type yarp::sig::Vector &. retval is of type bool. 
    ...
    %
    %curDof is of type yarp::sig::Vector &. curDof is of type yarp::sig::Vector &. retval is of type bool. 
      [varargout{1:nargout}] = yarpMEX(1430, self, varargin{:});
    end
    function varargout = setDOF(self,varargin)
    %Usage: retval = setDOF (newDof, curDof)
    %
    %newDof is of type yarp::sig::Vector const &. curDof is of type yarp::sig::Vector &. newDof is of type yarp::sig::Vector const &. curDof is of type yarp::sig::Vector &. retval is of type bool. 
    ...
    %
    %curRestPos is of type yarp::sig::Vector &. curRestPos is of type yarp::sig::Vector &. retval is of type bool. 
    ...
    %
    %newRestPos is of type yarp::sig::Vector const &. curRestPos is of type yarp::sig::Vector &. newRestPos is of type yarp::sig::Vector const &. curRestPos is of type yarp::sig::Vector &. retval is of type bool. 
    ...
    %
    %curRestWeights is of type yarp::sig::Vector &. curRestWeights is of type yarp::sig::Vector &. retval is of type bool. 
    ...
    %
    %newRestWeights is of type yarp::sig::Vector const &. curRestWeights is of type yarp::sig::Vector &. newRestWeights is of type yarp::sig::Vector const &. curRestWeights is of type yarp::sig::Vector &. retval is of type bool. 
    ...
    %
    %xdot is of type yarp::sig::Vector &. odot is of type yarp::sig::Vector &. xdot is of type yarp::sig::Vector &. odot is of type yarp::sig::Vector &. retval is of type bool. 
    ...
    %
    %xdot is of type yarp::sig::Vector const &. odot is of type yarp::sig::Vector const &. xdot is of type yarp::sig::Vector const &. odot is of type yarp::sig::Vector const &. retval is of type bool. 
    ...
    %
    %x is of type yarp::sig::Vector const &. o is of type yarp::sig::Vector const &. x is of type yarp::sig::Vector const &. o is of type yarp::sig::Vector const &. retval is of type bool. 
      [varargout{1:nargout}] = yarpMEX(1445, self, varargin{:});
    end
    function varargout = getTipFrame(self,varargin)
    %Usage: retval = getTipFrame (x, o)
    %
    %x is of type yarp::sig::Vector &. o is of type yarp::sig::Vector &. x is of type yarp::sig::Vector &. o is of type yarp::sig::Vector &. retval is of type bool. 
